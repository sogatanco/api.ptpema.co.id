    ...
    'connections' => [
        ...
        'op' => [
         ...
         'layar' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_w12', '127.0.0.1'),
            'port' => env('DB_PORT_w12', '3306'),
            'database' => env('DB_DATABASE_w12', 'forge'),
            'username' => env('DB_USERNAME_w12', 'forge'),
            'password' => env('DB_PASSWORD_w12', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'w12' => [
            'driver' => env('DB_CONNECTION_w12', 'mysql'),
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_w12', '127.0.0.1'),
